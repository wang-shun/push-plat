package com.lvmama.bms.core.constant;
...
public interface ExtConfig {
    ...
    String ALARM_EMAIL_TO = "alarm.email.to";
    String ALARM_EMAIL_TITLE = "alarm.email.title";

    String EMAIL_GLOBAL_STATIS_TITLE = "alarm.email.global.statis.title";
    String EMAIL_GLOBAL_STATIS_HEADER = "alarm.email.global.statis.header";

    String EMAIL_TOKEN_STATIS_TITLE = "alarm.email.token.statis.title";
    String EMAIL_TOKEN_STATIS_HEADER = "alarm.email.token.statis.header";

    String EMAIL_MSG_TYPE_STATIS_TITLE = "alarm.email.msg.type.statis.title";
    String EMAIL_MSG_TYPE_STATIS_HEADER = "alarm.email.msg.type.statis.header";

    String EMAIL_MSG_TOKEN_STATIS_TITLE = "alarm.email.msg.token.statis.title";
    String EMAIL_MSG_TOKEN_STATIS_HEADER = "alarm.email.msg.token.statis.header";

    String EMAIL_NODE_OFFLINE_TITLE = "alarm.email.node.offline.title";
    String EMAIL_NODE_OFFLINE_TABLE_TITLE = "alarm.email.node.offline.table.title";
    String EMAIL_NODE_OFFLINE_TABLE_HEADER = "alarm.email.node.offline.table.header";
     ...
     */
    String PROCESSOR_THREAD = "bms.job.processor.thread";
    
    /**
     * JobTracker推送线程数
     */
    String PUSH_THREAD = "bms.job.push.thread";
     ...
     * TaskTracker工作线程数
     */
    String TASK_WORK_THREAD = "bms.task.work.thread";
    ...
    String MSG_STORE = "msg.store";

    String REDIS_ADDRESS = "redis.address";

    String REDIS_PORT = "redis.port";

    String REDIS_NAME_SPACE = "redis.namespace";

    String REDIS_MAX_TOTAL = "redis.maxTotal";

    String MQ_BROKER_URL = "jms_server";

    String MQ_SYNC_TOPIC = "mq.syncTopic";

    String PUSH_FAIL_RETRY_INTERVAL = "push.fail.retry.interval";
