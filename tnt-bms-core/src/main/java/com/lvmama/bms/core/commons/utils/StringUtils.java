...
import com.lvmama.bms.core.logger.support.FormattingTuple;
import com.lvmama.bms.core.logger.support.MessageFormatter;
...
public final class StringUtils {
    ...
    public static String toString(Object value, boolean isReturnBlank) {
        if(value == null) {
            if(isReturnBlank) {
                return "";
            } else {
