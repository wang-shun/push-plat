...
import com.lvmama.bms.core.registry.NodeRegistryUtils;
...
public class Node {
    ...
    // 线程个数
    private Integer fastThreads;
    private Integer slowThreads;
    // 唯一标识
    ...
    public Integer getFastThreads() {
        return fastThreads;
    }

    public void setFastThreads(Integer fastThreads) {
        this.fastThreads = fastThreads;
    }

    public Integer getSlowThreads() {
        return slowThreads;
    }

    public void setSlowThreads(Integer slowThreads) {
        this.slowThreads = slowThreads;
    }
