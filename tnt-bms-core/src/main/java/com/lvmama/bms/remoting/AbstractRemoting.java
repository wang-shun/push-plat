...
import com.lvmama.bms.remoting.codec.DefaultCodec;
import com.lvmama.bms.remoting.common.RemotingHelper;
import com.lvmama.bms.remoting.common.SemaphoreReleaseOnlyOnce;
import com.lvmama.bms.remoting.common.ServiceThread;
import com.lvmama.bms.remoting.exception.RemotingSendRequestException;
import com.lvmama.bms.remoting.exception.RemotingTimeoutException;
import com.lvmama.bms.remoting.exception.RemotingTooMuchRequestException;
import com.lvmama.bms.remoting.protocol.RemotingCommand;
import com.lvmama.bms.remoting.protocol.RemotingCommandHelper;
                            ...
                            if (response != null) {
                                ...
                                try {
                                    channel.writeAndFlush(response).addListener(new ChannelHandlerListener() {
                                        @Override
                                        public void operationComplete(com.lvmama.bms.remoting.Future future) throws Exception {
                                            if (!future.isSuccess()) {
