...
import com.lvmama.bms.core.domain.monitor.MsgSchedulerMData;
 ...
 */
public class MsgSchedulerMStatReporter extends AbstractMStatReporter {

    public MsgSchedulerMStatReporter(MsgSchedulerAppContext appContext) {
        super(appContext);
    }
    ...
    protected MData collectMData() {
        MsgSchedulerMData mData = new MsgSchedulerMData();
