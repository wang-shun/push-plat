...
import com.lvmama.bms.core.domain.monitor.MsgPusherMData;
 ...
 */
public class MsgPusherMStatReporter extends AbstractMStatReporter {
    ...
    public MsgPusherMStatReporter(AppContext appContext) {
        super(appContext);
    }
    ...
    protected MData collectMData() {
        MsgPusherMData mData = new MsgPusherMData();
